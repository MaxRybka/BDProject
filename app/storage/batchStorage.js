...
async function getBatchesByInvoiceId(invId) {
    ...
    let res = await conn.query(`SELECT B.prod_cd, P.prod_name, B.bat_extra, B.bat_price, B.bat_amount, B.bat_initamount, B.bat_endprice, B.bat_lineprice, P.man_id, M.man_name
